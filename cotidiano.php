<?php
$texto = file_get_contents('https://combovideos.com.br/prod/generateXmlFiles/xmlFiles_4YouSee/genUolCotidiano_4YouSee.php');
...
<body>
    ...
    <div id="cena2">
        ...
        <!-- cotidiano -->
        <div id="cotidiano" class="animate__animated animate__delay-5s animate__fadeInDown"></div>
        <!-- circulo fino -->
